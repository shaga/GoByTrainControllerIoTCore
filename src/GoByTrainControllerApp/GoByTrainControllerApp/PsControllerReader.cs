...
namespace GoByTrainControllerApp
{
    class PsControllerReader
    {
        ...
        public bool SelectIsPressed => (_recvBuffer[3] & 0x80) == 0x00;

        public bool StartIsPressed => (_recvBuffer[3] & 0x10) == 0x00;

        public bool AIsPressed => (_recvBuffer[4] & 0x01) == 0x00;

        public bool BIsPressed => (_recvBuffer[4] & 0x02) == 0x00;

        public bool CIsPressed => (_recvBuffer[4] & 0x04) == 0x00;
